...
<?php
  ...
  $sql_table = mysqli_query($con,"SELECT DISTINCT (`diamond_status`), COUNT(*) AS statusCount,CEIL(SUM(`diamond_size`)) AS sumCarat FROM `diamonds` WHERE    `diamond_type` = 'Black' AND `diamond_lot_no` LIKE 'B%'  AND `diamond_status` NOT IN ('Invoiced' , 'Deleted') GROUP BY (`diamond_status`)");
  ...
  $sql_table_status = mysqli_query($con,"SELECT DISTINCT (`diamond_status`) FROM `diamonds` WHERE  `diamond_type` = 'Black' AND `diamond_lot_no` LIKE 'B%'  AND `diamond_status` NOT IN ('Invoiced' , 'Deleted') GROUP BY (`diamond_status`)");
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto navbar-right">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="black_diamond.php">Black Diamond <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
